      ...
      <div className="md:grid md:grid-cols-2 items-center py-8 px-4 xl:px-16">
        ...
        <div className="text-center md:text-left">
          ...
          <div className="grid grid-cols-2 justify-center ml-10 gap-2 mt-4">
            {/* Tab Block 1 - Skills */}
            <div
          className={`p-2 -ml-10 lg:p4 sm:w-3/1 md:w-2/3 lg:w-2/3 rounded-lg bg-gradient-to-r from-blue-500 to-green-500 transition-shadow duration-300 shadow-lg hover:shadow-xl cursor-pointer`}
              onMouseEnter={() => {
            ...
            >
              <h3 className="sm:text-sm md-text-md lg:text-lg font-bold">
                {TAB_DATA[0].icon}
                {TAB_DATA[0].title}
              </h3>
            ...
            <div
             className={`p-2 lg:p4 sm:w-3/1 md:w-2/3 lg:w-2/3 lg:-ml-20 sm:-mr-8 md:-mr-14 lg:-mr-16 rounded-lg bg-gradient-to-r from-purple-500 to-pink-500 transition-shadow duration-300 shadow-lg hover:shadow-xl cursor-pointer`}
              onMouseEnter={() => {
            ...
            <div
           className={`p-2 -ml-16 mr-5 lg:p4 sm:w-3/1 md:w-2/3 lg:w-2/3 rounded-lg bg-gradient-to-r from-orange-500 to-yellow-500 transition-shadow duration-300 shadow-lg hover:shadow-xl cursor-pointer`}
              onMouseEnter={() => {
            ...
            <div
              className={`sm:p-2 md:p3 lg:p4 sm:w-3/1 md:w-2/3 lg:w-2/3 -ml-5 -mr-8 rounded-lg bg-gradient-to-r from-teal-500 to-cyan-500 transition-shadow duration-300 shadow-lg hover:shadow-xl cursor-pointer`}
              onMouseEnter={() => {
